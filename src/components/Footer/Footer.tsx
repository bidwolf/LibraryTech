    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.socials}>
        <SocialNetwork name="Github"
          link="https://github.com/bidwolf"
          icon={{
            src: "imagens/github.svg",
            alt: "logo do github"
          }} />
        <SocialNetwork name="Linkedin"
          link="https://www.linkedin.com/in/henriquedepaularodrigues/"
          icon={{
            src: "imagens/linkedin.svg",
            alt: "logo do linkedin"
          }} />
        <SocialNetwork name="Instagram"
          link="https://www.instagram.com/henrique._.exe/"
          icon={{
            src: "imagens/instagram.svg",
            alt: "logo do instagram"
          }} />
        <SocialNetwork name="Twitter"
          link="https://twitter.com/henrique_exe"
          icon={{
